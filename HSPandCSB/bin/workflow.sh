...
if [ $MG == 0 ]; then
	...
	${BINDIR}/getDuplicatedCSB ${seqXName}-${seqYName}.fil ${seqXName}-${seqYName}.fil.dup ${seqXName}-${seqYName}.csb.txt > ${seqXName}-${seqYName}-getCSBDuplog.txt

	
	echo "${BINDIR}/getCSB ${seqXName}-${seqYName}.fil ${seqXName}-${seqYName}.csb ${seqXName}-${seqYName}.csb.txt > ${seqXName}-${seqYName}-getCSBlog.txt" 
	${BINDIR}/getCSB ${seqXName}-${seqYName}.fil.dup ${seqXName}-${seqYName}.csb ${seqXName}-${seqYName}.csb.txt > ${seqXName}-${seqYName}-getCSBlog.txt
